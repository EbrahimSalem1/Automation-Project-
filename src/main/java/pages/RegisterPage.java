...
public class RegisterPage extends MethodHandles {
    ...
    public final By emailAlreadyExistTxt = By.xpath("//p[normalize-space()='Email Address already exist!']");
    ...
    @Step
    public String emailAlreadyExistErrorTxt(){
        return driver.findElement(emailAlreadyExistTxt).getText();
    }
}